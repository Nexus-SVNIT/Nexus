...
const makeCollectionName = (eventName)=>{
    const collectionName = eventName.toLowerCase().replace(/ /g, '_')+'_response';
...
const submitResponse = async (req, res) => {
    ...
    if(!mongoose.models[collectionName])
        ResponseCollection = mongoose.model(collectionName, responseSchema); // it should be mongoose.models[] and not mongoose.model[]
    else
        ResponseCollection = mongoose.models[collectionName];
...
module.exports = { getAllEvents, getSingleEvent, addEvent, updateEvent, deleteEvent, submitResponse, getResponses };