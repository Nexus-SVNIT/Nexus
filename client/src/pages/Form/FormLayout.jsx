              ...
              <div className="p-6.5">
                ...
                <div className="mb-4.5">
                  ...
                  <div className="dark:bg-form-input relative z-20 bg-transparent">
                    <select className="border-stroke focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary relative z-20 w-full appearance-none rounded border bg-transparent px-5 py-3 outline-none transition">
