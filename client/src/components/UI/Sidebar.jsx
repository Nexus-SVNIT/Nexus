            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        Forms
                        <svg
                          className={`absolute left-auto right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && "rotate-180"
                          }`}
                          width="20"
                          height="20"
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("responses") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("add-project") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/core/admin/verify-posts"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("create-panel") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                  ...
                  Verify Interview Expirence Posts
                </NavLink>
              </li>
              <li>
                <NavLink
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("verify-achievements") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
              ...
              <li>
                ...
                >
                  ...
                  Verify InterviewExperience
                </NavLink>
              </li>

              <li>
                <NavLink
                  to="/core/admin/verify-alumni"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("verify-alumni") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
              ...
              <li>
                <NavLink
                  to="/core/admin/add-team-member"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("add-team-member") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
              ...
              <li>
                <NavLink
                  to="/core/admin/general-notification"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("general-notification") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
