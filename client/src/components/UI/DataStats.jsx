const DataStats = () => {
  return (
    <div className="border-stroke p-7.5 shadow-default dark:border-strokedark dark:bg-boxdark col-span-12 rounded-sm border bg-white">
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4 xl:gap-0">
        <div className="border-stroke dark:border-strokedark flex items-center justify-center gap-2 border-b pb-5 xl:border-b-0 xl:border-r xl:pb-0">
          <div>
            <h4 className="md:text-title-lg mb-0.5 text-xl font-semibold text-black dark:text-white">
              $4,350
            </h4>
        ...
        <div className="border-stroke dark:border-strokedark flex items-center justify-center gap-2 border-b pb-5 sm:border-b-0 sm:pb-0 xl:border-r">
          <div>
            <h4 className="md:text-title-lg mb-0.5 text-xl font-semibold text-black dark:text-white">
              54%
            </h4>
