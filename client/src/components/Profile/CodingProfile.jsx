...
const CodingProfile = ({ leetcodeProfile, codeforcesProfile, codechefProfile }) => {
  ...
  const codeforcesProfileData = codeforcesData[0];
  const codeforcesRatings = codeforcesData[1]?.ratings?.map((rating) => ({
