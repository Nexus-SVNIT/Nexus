        ...
        >
          <h2 className="text-xl font-semibold text-white flex items-center gap-3">
            <div className="relative">
              ...
              />
              <svg className="w-5 h-5 text-blue-400 relative" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <div className="flex flex-wrap gap-2">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    onClick={() => quickAsk("Give me an OA preparation strategy with topic-wise focus and time plan.")}
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    onClick={() => quickAsk("What are the most frequent DSA and CS core topics in technical rounds?")}
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    onClick={() => quickAsk("Summarize asked questions and compensation trends from recent posts.")}
            ...
            >
              <div className="flex-grow">
                <textarea
                  ...
                  placeholder={company ? `Ask anything about ${company}...` : "Select a company to start chatting"}
