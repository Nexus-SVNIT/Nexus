...
var exports = function () {
  ...
  Points.prototype.init = function (param) {
    ...
    this.geometry.setAttribute(
      "position",
      new THREE.BufferAttribute(param.positions, 3),
    );
    this.geometry.setAttribute(
      "customColor",
      new THREE.BufferAttribute(param.colors, 3),
    );
    this.geometry.setAttribute(
      "vertexOpacity",
      new THREE.BufferAttribute(param.opacities, 1),
    );
    this.geometry.setAttribute(
      "size",
      new THREE.BufferAttribute(param.sizes, 1),
    );
